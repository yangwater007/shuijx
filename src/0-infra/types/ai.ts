...
export interface NewsItem {
  id: number; title: string; content: string; brief: string;
  ctime: number; level: string; readingNum: number; type: number;
}

export interface KaipanlaItem {
  code: string; name: string; hotRank: number; rank: number;
  rankChange: number; value: number; changePercent: number;
  conceptTags: string[]; tags: string[];
  analyse: string; analyseTitle: string;
}
